...
#
# Uso:
#   ./export-pdf.sh                  → convierte week-01-fundamentos_typescript (por defecto)
#   ./export-pdf.sh week-02-introduccion_react          → convierte week-02-introduccion_react
#   ./export-pdf.sh week-01-fundamentos_typescript --merge  → convierte y genera un PDF combinado
#
# Dependencias:
#   - Node.js >= 18
#   - pnpm
...
# ── Argumentos ───────────────────────────────────────────────────────────────
WEEK="${1:-week-01-fundamentos_typescript}"
MERGE="${2:-}"
